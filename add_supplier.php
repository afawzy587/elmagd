...
//					@unlink($path.$_POST['old_suppliers_doc']);
				...
				$add = $setting_supplier->addSettings_suppliers($_supplier);
				if($add == 1)
				{
					$logs->addLog(NULL,
						array(
						...
						header("Location:./add_supplier.php?action=add");
						exit;
				}
			}
		}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" name="suppliers_name" placeholder=" <?php echo $lang['SETTINGS_SU_NAME'];?>" value ="<?php if($_supplier){echo $_supplier['suppliers_name'];}?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-3"> <?php echo $lang['SETTINGS_SU_ADDRESS'];?></label>
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" name="suppliers_address" value ="<?php if($_supplier){echo $_supplier['suppliers_address'];}?>"
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" name="suppliers_phone_one"
                                            placeholder="<?php echo $lang['SETTINGS_SU_PHONE_1'];?>" value ="<?php if($_supplier){echo $_supplier['suppliers_phone_one'];}?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" name="suppliers_phone_two"
                                            placeholder="<?php echo $lang['SETTINGS_SU_PHONE_2'];?>" value ="<?php if($_supplier){echo $_supplier['suppliers_phone_two'];}?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">

    ...
    <div class="container mainPageContainer">
        ...
        <div class="row mt-5 mb-3">
            <div class="col">
                ...
                <span class="blueSky"><strong> &gt; </strong> <?php echo $lang['ABOUT_TITLE'];?> </span>
            </div>
        </div>
        <!-- end links row -->
        ...
        <div class="row centerContent">
            <div class="col-md-9 darker-bg centerDarkerDiv aboutacenterDiv">
                <h5 class="text-center"><?php echo $lang['ABOUT_CONTENT'];?> </h5>
                <div class="text-center mt-3">
                    <img src="<?php echo $path;echo ($companyinfo['companyinfo_logo'])?$companyinfo['companyinfo_logo']:$avater_default;?>" height=75 />
                </div>

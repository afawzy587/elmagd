    ...
    if($login->doCheck() == false)
    {
		...
		}else
		{
            ...
            if($_POST)
            {
                ...
                //         {
                //             header("Location:./add_clients_deposit.php?id=".$mId);
                //         }else{
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" name="deposits_cheque_number" id="check_number"
                                        placeholder="------">
                                    </div>
                                </div>
                            </div>
            ...
            var page   ="bank_js.php?do=get_invoices";
             if(bank && acount_type && acount_id){
                    $.ajax({
                        type:'POST',
                        url:page,
                        data:{bank:bank,acount:acount_type,acount_id:acount_id},
                        success:function(html)
                        {
                            console.log(html);

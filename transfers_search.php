    ...
    <div class="row mt-5">
     ...
     <!-- add/edit department row -->
        <div class="row centerContent">
            <div class="col">
                <form action="./transfers.php" id="banksOperationsSearchForm">
                    <h5> <?php echo $lang['TRANSFERS_SEARCH_TITLE']; ?></h5>
                  	 ...
                  	 <div class="row">
						<div class="col-md-5">
							<div class="form-group">
								...
								<div class="col-xs-5">
									<div class="select">
										<select name="bank_to" id="transfer_to" class="bank invoices form-control">
											<option selected disabled> <?php echo $lang['SETTINGS_C_F_CHOOSE_BANK']; ?></option>
											<option value="safe"><?php echo $lang['SETTINGS_C_F_SAFE']; ?></option>
											<?php
											if ($banks) {
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<div class="col-xs-5">
									<div class="select">
										<select name="account_to" id="transfer_account_id_to" class="form-control">
										</select>
									</div>
								</div>
							</div>

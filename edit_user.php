    ...
    if($login->doCheck() == false)
    {
		...
		}else
		{
			if (intval($_GET['id']) != 0)
			{
				...
				$u = $setting_user->getSettings_usersInformation($mId);
				if($_POST)
				{
					$_user['users_sn']                          =       $mId;
					...
					$edit = $setting_user->setSettings_usersInformation($_user);
					if($edit == 1)
					{
						$logs->addLog(NULL,
							array(
							...
							header("Location:./settings_users.php?action=edit");
							exit;
					}
				}
		}else{
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" name="users_name" value ="<?php if($_user){echo $_user['users_name'];}else{echo $u['users_name'];}?>"
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="date" name="users_birthday" class="form-control" value ="<?php if($_user){echo $_user['users_birthday'];}else{echo $u['users_birthday'];}?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <select name="users_department_id" class="form-control" id="slct">
                                                ...
                                                <?php 
													if($departments)
													{
														...
														{
															echo'<option value="'.$d['departments_sn'].'"';if($_user){if( $_user['users_department_id'] == $d['departments_sn']){echo'selected';}}else{if($u['users_department_id'] == $d['departments_sn']){echo'selected';}}echo'>'.$d['departments_name'].'</option>';
														}
													}
												?>
                                              </select>
                                            ...
                                            <select name="users_job_id" class="form-control" id="slct">
                                                ...
                                                <?php 
													if($jobs)
													{
														foreach($jobs as $k=>$j)
														{
															echo'<option value="'.$j['jobs_sn'].'"';if($_user){if($_user['users_job_id']==$j['jobs_sn']){echo'selected';}}else{if($u['users_job_id']==$j['jobs_sn']){echo'selected';}}echo'>'.$j['jobs_name'].'</option>';
														}
													}
												?>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" name="users_qualification" value ="<?php if($_user){echo $_user['users_qualification'];}else{echo $u['users_qualification'];}?>"
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" name="users_graduation_year" value ="<?php if($_user){echo $_user['users_graduation_year'];}else{echo $u['users_graduation_year'];}?>"
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 ">
                                        <input type="text" class="form-control" name="users_phone" value ="<?php if($_user){echo $_user['users_phone'];}else{echo $u['users_phone'];}?>"
                                        ...
                                        <div class="col-md-7 ">
                                            ...
                                            <div class="upload-btn-wrapper">
                                                ...
                                                <input type="file" class="form-control uploadimage" id="logo"
                                                    name="users_photo">
                                                    <input type="text" class="form-control uploadimage" 
                                                    name="old_users_photo" value="<?php echo $u['users_photo'];?>" hidden>
                                            </div>
                                        </div>
                                        <div class="col-md-5 d-flex justify-content-end align-items-end mb-2">
                                            <img src="<?php echo $path.$u['users_photo'];?>" height="50px" class="imagePreviewURL" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" name="users_address" value ="<?php if($_user){echo $_user['users_address'];}else{echo $u['users_address'];}?>"
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 ">
                                        <input type="text" class="form-control" name="users_email" autocomplete="new-password"  placeholder="user@abc.com" value ="<?php if($_user){echo $_user['users_email'];}else{echo $u['users_email'];}?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                            ...
                                            <select name="users_group" class="form-control" id="slct">
                                                ...
                                                <?php 
													if($groups)
													{
														...
														{
															echo'<option value="'.$g['group_sn'].'"';if($_user){if($_user['users_group']==$g['group_sn']){echo'selected';}}else{if($u['users_group']==$g['group_sn']){echo'selected';}}echo'>'.$g['group_name'].'</option>';
														}
													}
												?>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 ">
                                        <input type="text" class="form-control" name="users_salary" value ="<?php if($_user){echo $_user['users_salary'];}else{echo $u['users_salary'];}?>"

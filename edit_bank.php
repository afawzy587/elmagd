                                            ...
                                            <div class="row justify-content-start">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-5">
                                                            <input type="text" class="account_valide form-control" name="banks_credit_name[0]" value="<?php if($_bank){echo $_bank['banks_credit_name'][0];}else{echo $u['banks_credit'][0]['banks_credit_name'];}?>"
                                                ...
                                                <div class="row justify-content-start">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="col-xs-3"><?php echo $lang['SETTINGS_BAN_DUE_INT'];?></label>
                                                            <div class="col-xs-5">
                                                                <input type="text" class="account_valide form-control" name="banks_saving_duration_of_interest" value="<?php if($_bank){echo $_bank['banks_saving_account_number'];}else{echo $u['banks_saving_account_number'];}?>"
                                                                    placeholder="--">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="col-xs-3"> <?php echo $lang['SETTINGS_BAN_CUR_CODE'];?></label>
                                                            <div class="col-xs-5">
                                                                <input type="text" class="account_valide form-control" name="banks_current_account_number" value="<?php if($_bank){echo $_bank['banks_current_account_number'];}else{echo $u['banks_current_account_number'];}?>"
                                                                    placeholder="--">
                                                            </div>
                                                        </div>
                                                    </div>
